...
- **Student Name**: Ashish Kumar Yadav
- **Registration Number**: 24BCE10880
...
3. Run any file using `./script_name.sh`. For example:
   ...
   ./sys_identity.sh
   ```
   _(Note: Script 4 (`log_analyzer.sh`) requires a file path argument, for example: `./log_analyzer.sh /var/log/syslog error`)._
